    ...
    UserManager<User> userManager):IJwtRepository
{
   ...
   // private readonly IConfiguration _configuration = configuration;
    ...
    private  const string ISSUE = "onlinetrainingapi.lan";
    private  const string AUDIENCE = "onlinetrainingapi.lan";
    private  const string SUBJECT = "JWT for onlinetrainingapi.lan";
